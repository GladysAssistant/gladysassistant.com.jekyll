...
gulp.task('concat-scripts', function() {
  return gulp
    .src([
      './web/assets/js/prism.js',
      './web/assets/js/sweetalert.min.js',
      './web/assets/js/rrssb.min.js',
...
gulp.task('concat-css', function() {
  return gulp
    .src([
      ...
      './assets/css/rrssb.css',
      './assets/css/new-age.css',
      './assets/css/main.css',
    ])
...
gulp.task('uglify-js', ['concat-scripts'], function() {
  return gulp
    .src('./web/assets/js/production/production.js')
    .pipe(uglify())
...
gulp.task('compress-images', function() {
  return gulp
    .src('./web/assets/images/products/*.jpg')
    .pipe(
    ...
    .then(() => {
      ...
      return Promise.map(
        ...
        (product) => {
          ...
          return download(product.img, 'assets/images/products-crowdsourced', {
            filename: product.img_file,
          }).catch((err) => {
            console.log('Cannot download image ' + product.img);
            throw err;
          });
        },
        {
